...
<script type="text/javascript" src="<?php echo $path; ?>Modules/energyaudit/stack_lib/process2.js"></script>
<script type="text/javascript" src="<?php echo $path; ?>Modules/energyaudit/stack_lib/stacks.js"></script>
<script type="text/javascript" src="<?php echo $path; ?>Modules/energyaudit/stack_lib/sort.js"></script>
